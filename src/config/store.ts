...
export const TOKEN_PACKS: TokenPack[] = [
  { id: 'spark',    name: 'Spark',     tokens: 100,  price: '$0.99',  description: 'Train one basic weapon' },
  { id: 'charge',   name: 'Charge',    tokens: 300,  price: '$2.99',  description: 'Skip two days of grinding' },
  { id: 'surge',    name: 'Surge',     tokens: 600,  price: '$4.99',  description: 'Train a full soldier' },
  { id: 'arsenal',  name: 'Arsenal',   tokens: 1500, price: '$9.99',  description: 'Arm your entire squad', featured: true },
  { id: 'warchest', name: 'War Chest', tokens: 5000, price: '$24.99', description: 'Train your entire army' },
]
